...
const Hero = () => {
  ...
  return (
    <div className="dark:bg-[#121212] min-h-screen">
      ...
      {/* Hero Section */}
      <section className="h-[70vh] flex flex-col justify-center items-center text-center px-6 sm:px-12 md:px-24 pt-24 bg-white dark:bg-[#121212]">
        <motion.p
        ...
        >
          <a
            ...
            className="px-6 py-3 bg-black dark:bg-white text-white dark:text-black rounded-sm hover:bg-white dark:hover:bg-black hover:text-black transition"
          >
            Download CV
          </a>
          <a
            href="https://github.com/JoshiNirdesh?tab=repositories"
            className="px-6 py-3 border border-black dark:border-white dark:bg-white rounded-sm hover:bg-black hover:text-white dark:hover:text-black transition"
          >
            My Projects
          </a>
        </motion.div>
      ...
      {/* Intro / Summary */}
      <motion.div
        className="px-12 md:px-24 mt-20 text-2xl md:text-4xl leading-relaxed text-gray-700 dark:text-white"
